      ...
      <table class="price-table">
        <tbody>
          ...
          <tr>
            ...
            <td class="price">
              <svg //cai hinh tuong trung cho cac loai plan
                xmlns="http://www.w3.org/2000/svg"
                data-name="Layer 1"
                viewBox="0 0 128 128">
                <defs />
          ...
          <tr>
            <td>
              <a href="#wordpress-asset-updates" class="price-table-help">
          ...
          <tr>
            <td>
              <a href="#wordpress-security-monitoring" class="price-table-help">
                <i class="far fa-fw fa-question-circle"></i>
              </a>{" "}
              Chart Annotations
            </td>
          ...
          <tr>
            <td>
              <a href="#wordpress-uptime-monitoring" class="price-table-help">
                <i class="far fa-fw fa-question-circle"></i>
              </a>{" "}
              Uptime Monitoring
            </td>
          ...
          <tr>
            <td>
              <a href="#wordpress-malware-cleanup" class="price-table-help">
                <i class="far fa-fw fa-question-circle"></i>
              </a>{" "}
              Weekly Reports
            </td>
          ...
          <tr>
            <td>
              <a href="#wordpress-security-audit" class="price-table-help">
                <i class="far fa-fw fa-question-circle"></i>
              </a>{" "}
              Security Audit
            </td>
          ...
          <tr>
            <td>
              <a href="#wordpress-priority-support" class="price-table-help">
                <i class="far fa-fw fa-question-circle"></i>
              </a>{" "}
              Priority Support
            </td>
          ...
          <tr>
            <td>
              <a href="#wordpress-billing" class="price-table-help">
                <i class="far fa-fw fa-question-circle"></i>
              </a>{" "}
